...
賴薇伊老師在台中提供豎琴個別課程，每堂 50 分鐘，一期 8 堂課，學費 NT$1,000–1,500 / 堂。30 年教學經驗，從 5 歲兒童到樂齡族群皆可教學。歡迎透過 LINE 預約免費諮詢。
    `},{id:"harp-price",tag:"選購指南",tagColor:"#D4A017",readTime:"4 分鐘",title:"豎琴多少錢？2025 年台灣豎琴價格完整指南",summary:"豎琴的價格從數千元到數十萬元不等，讓許多人望而卻步。本文詳細說明不同類型豎琴的價格範圍，幫助您找到最適合預算的選擇。",content:`
## 豎琴價格一覽
...
「我 62 歲才開始學豎琴，原本擔心學不會。但賴老師很有耐心，用我能理解的方式教學。現在每次上課都是我一週中最期待的時光。」— 學員家長（台中，65 歲）
    `},{id:"abrsm-harp",tag:"考級指南",tagColor:"#0891b2",readTime:"4 分鐘",title:"ABRSM 英國皇家音樂學院豎琴考級完整指南",summary:"ABRSM 是全球最具權威的音樂考級機構，豎琴考級分為 1–8 級。本文介紹考級制度、各級要求、備考建議，以及台灣的考試資訊。",content:`
## 什麼是 ABRSM 豎琴考級？
