...
HopeHarp 希望豎琴提供 17 弦到 40 弦的完整產品線，並提供短期租借服務（17 弦每月 NT$500，27 弦每月 NT$1,200），讓您在購買前先體驗。
...
賴薇伊老師在台中提供豎琴個別課程，每堂 50 分鐘，一期 8 堂課，學費 NT$1,000–1,500 / 堂。30 年教學經驗，從 5 歲兒童到樂齡族群皆可教學。歡迎透過 LINE 預約免費諮詢。
    `,relatedIds:["lever-harp","harp-price","harp-vs-piano"]},"harp-price":{id:"harp-price",tag:"選購指南",tagColor:"#D4A017",readTime:"4 分鐘",title:"豎琴多少錢？2025 年台灣豎琴價格完整指南",summary:"豎琴的價格從數千元到數十萬元不等，讓許多人望而卻步。本文詳細說明不同類型豎琴的價格範圍，幫助您找到最適合預算的選擇。",content:`
## 豎琴價格一覽
...
| 中型豎琴 | 27 弦 | NT$18,000–40,000 | 初學進階、成人 |
| 大型豎琴 | 34–40 弦 | NT$45,000–150,000 | 進階演奏、教學 |
| 踏板豎琴 | 46–47 弦 | NT$300,000–1,000,000+ | 專業演奏 |

## HopeHarp 希望豎琴的價格

HopeHarp 是台灣自有品牌，擁有台灣專利，提供最具性價比的豎琴選擇：

- **Hope 8S**（8 弦）：NT$3,980
- **Hope 17S**（17 弦，無調音鍵）：NT$5,980
- **Hope 17L**（17 弦，有調音鍵）：NT$8,800
- **Hope 27S**（27 弦）：NT$38,000 起
...
1. **不建議購買二手豎琴**（除非由專業技師檢查）：豎琴的弦、調音鍵、共鳴板都可能因使用不當而損壞
2. **確認售後服務**：購買時確認是否提供調音、維修服務
3. **試奏後再決定**：不同品牌的音色差異很大，建議親自試奏
    `,relatedIds:["beginner-guide","harp-vs-piano","abrsm-harp"]},"harp-vs-piano":{id:"harp-vs-piano",tag:"學習比較",tagColor:"#2d7a4f",readTime:"4 分鐘",title:"豎琴 vs 鋼琴：哪個更適合我的孩子學？",summary:"豎琴與鋼琴都是優雅的樂器，但各有特色。本文從學習難度、費用、適合年齡、未來發展等面向，幫助家長做出最適合的選擇。",content:`
## 豎琴與鋼琴的主要差異
...
完全可以！有鋼琴基礎的學生通常能更快掌握豎琴的樂理與視譜，學習進度會比零基礎更快。賴薇伊老師同時教授豎琴與鋼琴，可以為您規劃最適合的學習路徑。
    `,relatedIds:["beginner-guide","harp-price","slow-practice"]},"slow-practice":{id:"slow-practice",tag:"練習技巧",tagColor:"#7c3aed",readTime:"3 分鐘",title:"豎琴慢練的秘密：為什麼慢練才是進步最快的方法？",summary:"許多學生急於彈快，卻忽略了慢練的重要性。本文解釋慢練的科學原理，以及如何正確地進行豎琴慢練，讓您的進步速度翻倍。",content:`
## 為什麼要慢練？
...
賴薇伊老師在 30 年教學中發現，能夠堅持慢練的學生，通常在 3–6 個月內就能彈出完整的曲子，而急於求快的學生往往需要更長時間才能修正錯誤習慣。「慢即是快」，這是豎琴學習中最重要的觀念。
    `,relatedIds:["beginner-guide","abrsm-harp","senior-music"]},"senior-music":{id:"senior-music",tag:"樂齡音樂",tagColor:"#c0392b",readTime:"5 分鐘",title:"50 歲以上學豎琴：樂齡族群的音樂療癒完整指南",summary:"許多人認為學樂器要趁年輕，但研究顯示，50 歲以後學習音樂對大腦與身心有特別顯著的益處。本文專為樂齡族群介紹豎琴學習的優勢與注意事項。",content:`
## 樂齡學豎琴的特別優勢

**1. 大腦可塑性持續到老年**
神經科學研究證實，大腦的學習能力並不會隨年齡完全消失。學習新的樂器能刺激大腦形成新的神經連結，有效延緩認知退化。
...
**3. 社交與心理效益**
音樂課程提供定期的社交互動，透過合奏與分享，建立正向的人際關係，有效對抗退休後的孤獨感。
...
賴薇伊老師在中國文化大學推廣教育部台中分部開設「樂齡藝術輔療」與「樂齡音樂輔療」正式課程，專為 50 歲以上的樂齡族群設計，結合音樂欣賞、豎琴演奏與音樂療癒活動，是台中最專業的樂齡音樂課程之一。

## 學員心聲

「我 62 歲才開始學豎琴，原本擔心學不會。但賴老師很有耐心，用我能理解的方式教學。現在每次上課都是我一週中最期待的時光。」— 學員家長（台中，65 歲）
    `,relatedIds:["beginner-guide","slow-practice","harp-price"]},"abrsm-harp":{id:"abrsm-harp",tag:"考級指南",tagColor:"#0891b2",readTime:"4 分鐘",title:"ABRSM 英國皇家音樂學院豎琴考級完整指南",summary:"ABRSM 是全球最具權威的音樂考級機構，豎琴考級分為 1–8 級。本文介紹考級制度、各級要求、備考建議，以及台灣的考試資訊。",content:`
## 什麼是 ABRSM 豎琴考級？
